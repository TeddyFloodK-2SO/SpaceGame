...
<main class="game-page">
    <h1 class="game-title">Уничтожен</h1>
    <div class="game-grid">
        ...
        <div class="left-column">
            ...
            <div class="actions-window">
                <form action="${pageContext.request.contextPath}/dead" method="post">
                    <button type="submit" name="action" value="start_over" class="action-button">
                        🟢 Начать заново.
                    </button>
                </form>
            </div>
        ...
        <div class="right-column">
            ...
            <div class="game-picture">
                <img src="${pageContext.request.contextPath}/images/${sessionScope.player.currentImage}" alt="Смерть"
                     class="game-image"/>
            </div>
        </div>
