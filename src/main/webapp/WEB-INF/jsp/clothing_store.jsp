...
<main class="game-page">
    <h1 class="game-title">Second-hand</h1>
    <div class="game-grid">
        ...
        <div class="left-column">
            ...
            <div class="actions-window">
                <form action="${pageContext.request.contextPath}/clothing_store" method="post">
                    <button type="submit" name="action" value="dress_up" class="action-button">
                        🟢 Приодеться.
                    </button>
        ...
        <div class="right-column">
            ...
            <div class="game-picture">
                <img src="${pageContext.request.contextPath}/images/${sessionScope.player.currentImage}"
                     alt="Секонд-хенд" class="game-image"/>
            </div>
        </div>
