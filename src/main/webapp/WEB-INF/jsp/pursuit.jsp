...
<main class="game-page">
    <h1 class="game-title">Преследование</h1>
    <div class="game-grid">
        ...
        <div class="left-column">
            ...
            <div class="actions-window">
                <form action="${pageContext.request.contextPath}/pursuit" method="post">
                    <button type="submit" name="action" value="pass_out" class="action-button">
                        🟢 Вырубиться. Опять.
                    </button>
                </form>
            </div>
        ...
        <div class="right-column">
            ...
            <div class="game-picture">
                <img src="${pageContext.request.contextPath}/images/${sessionScope.player.currentImage}"
                     alt="Преследование" class="game-image"/>
            </div>
        </div>
