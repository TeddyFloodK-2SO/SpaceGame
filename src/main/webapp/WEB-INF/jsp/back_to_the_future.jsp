...
<main class="game-page">
    <h1 class="game-title">Вернуться в будущее</h1>
    <div class="game-grid">
        ...
        <div class="left-column">
            ...
            <div class="actions-window">
                <form action="${pageContext.request.contextPath}/back_to_the_future" method="post">
                    <button type="submit" name="action" value="leave_the_cave" class="action-button">
                        🟢 Покинуть пещеру.
                    </button>
        ...
        <div class="right-column">
            ...
            <div class="game-picture">
                <img src="${pageContext.request.contextPath}/images/${sessionScope.player.currentImage}"
                     alt="Покинуть пещеру" class="game-image"/>
            </div>
        </div>
