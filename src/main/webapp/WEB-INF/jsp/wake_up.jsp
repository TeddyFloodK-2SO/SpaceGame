...
<main class="game-page">
    <h1 class="game-title">Возврат сознания</h1>
    <div class="game-grid">
        ...
        <div class="left-column">
            ...
            <div class="actions-window">
                <form action="${pageContext.request.contextPath}/wake_up" method="post">
                    <button type="submit" name="action" value="pursuit" class="action-button">
                        🟢 Начать преследование гавнюка.
                    </button>
                    <button type="submit" name="action" value="go_to_the_store" class="action-button">
                        🟢 Кажется я вижу магазин одежды.
                    </button>
                </form>
            </div>
        ...
        <div class="right-column">
            ...
            <div class="game-picture">
                <img src="${pageContext.request.contextPath}/images/${sessionScope.player.currentImage}"
                     alt="Возврат сознания" class="game-image"/>
            </div>
        </div>
